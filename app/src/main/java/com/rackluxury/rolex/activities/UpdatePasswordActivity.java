                    ...
                    firebaseUser.updatePassword(userPasswordNew).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toasty.success(UpdatePasswordActivity.this, "Password Changed", Toast.LENGTH_LONG).show();

                                firebaseAuth.signOut();
                                finish();
                                Intent openLoginActivityFromUpdatePassword = new Intent(UpdatePasswordActivity.this, LoginActivity.class);
                                startActivity(openLoginActivityFromUpdatePassword);
