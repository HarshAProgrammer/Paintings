...
import com.rackluxury.paintings.youtube.model.PlaylistVideos;
...
public class PlaylistCardAdapter extends RecyclerView.Adapter<PlaylistCardAdapter.ViewHolder> {
    ...
    private final com.rackluxury.paintings.youtube.YouTubeRecyclerViewFragment.LastItemReachedListener mListener;
    ...
    public PlaylistCardAdapter(PlaylistVideos playlistVideos, com.rackluxury.paintings.youtube.YouTubeRecyclerViewFragment.LastItemReachedListener lastItemReachedListener) {
