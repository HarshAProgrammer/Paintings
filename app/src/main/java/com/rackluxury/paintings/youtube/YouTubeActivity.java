package com.rackluxury.paintings.youtube;
...
public class YouTubeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (com.rackluxury.paintings.youtube.ApiKey.YOUTUBE_API_KEY.startsWith("YOUR_API_KEY")) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.container, com.rackluxury.paintings.youtube.YouTubeRecyclerViewFragment.newInstance(mYoutubeDataApi, YOUTUBE_PLAYLISTS))
                    .commit();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_recyclerview) {
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.container, com.rackluxury.paintings.youtube.YouTubeRecyclerViewFragment.newInstance(mYoutubeDataApi, YOUTUBE_PLAYLISTS))
                    .commit();
            return true;
        }
