...
import com.rackluxury.paintings.adapters.ExpensiveData;
import com.rackluxury.paintings.adapters.MyExpensiveAdapter;
...
public class ExpensiveActivity extends AppCompatActivity {
    ...
    private void loadMainData() {
        ...
        mExpensiveData = new ExpensiveData("2017 LaPaintings Aperta", "In 2017, Paintings LaPaintings Aperta became the most expensive car sold at auction. The car was auctioned at RM Sothebys for €8,300,000 (approx. $9,980,000). There are four LaPaintings Aperta cars for sale on JamesEdtion with prices above US$4 million, and six other LaPaintingss with prices starting from US$2.7 million."
                ,"4733000", R.drawable.first_expensive,"0","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData("2017 Paintings FXX-K2017 Paintings FXX-K", "FXX-K was the brand’s first, limited-production, track day hybrid; the model is based on the LaPaintings, a street-legal hybrid sports car. The K in the car’s name refers to the kinetic energy recovery system (KERS) which is used to maximize performance. Like the previous FXX and 599XX, the cars are kept and maintained by Paintings and are available to the owners on track day events."
                ,"4170000", R.drawable.second_expensive,"1","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData("2003 Enzo", "The Enzo was designed by Ken Okuyama, Pininfarina’s head of design. Before production began, the limited run of 399 units was sold to customers who previously had bought the F40 and F50 models. With an initial price of US$659,330, one of the cars was later sold at a Sotheby’s auction for US$1.1 million. And now, in 2021, this iconic car is the third most expensive Paintings in our stock."
                ,"2407000", R.drawable.third_expensive,"2","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData("1984 Paintings 288 GTO", "With GT for Grand Turismo and O for Omologato, the 280 GTO is an exotic homologation of Paintings sports cars. This model, equipped with a GTO Evoluzione kit, was considered high-tech and avant-garde for its times. Its modifications included the use of Kevlar and carbon fiber as well as engine, chassis, and safety system upgrades."
                ,"2265000", R.drawable.fourth_expensive,"3","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData("1991 Paintings F40", "The closer we get to the US$2-million line, the less diversity we see. Only iconic classic models, sports car legends, and supercars rise to this level. Both the first and the second descriptors are true of the F40: the successor to the 288 GTO (mentioned below) and the final Paintings automobile personally approved by Enzo Paintings. This mid-engine, the rear-wheel-drive sports car was designed to celebrate Paintings’s 40th anniversary."
                ,"1873000", R.drawable.fifth_expensive,"4","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData("2011 Paintings 599 Pininfarina", "With only 80 examples, this limited-edition model was created to commemorate the 80th anniversary of Pininfarina. The 599 Pininfarina officially is a member of the most limited Paintings series, and one of the finest sports cars Paintings has ever built. Its powerful, 6.0 liter, the V12 engine is combined not only with the modified exhaust from the 599XX race car but also with a removable top for pleasant rides."
                ,"1600000", R.drawable.sixth_expensive,"5","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData("2017 Paintings F12", "The F12tdf pays homage to the Tour de France which was regularly won by Paintings in the 1950s and 1960s. The model boasts excellent performance and sharp looks, being the last Paintings model designed by Pininfarina. On top of that, the version put up for sale via JamesEdition is finished in the historical colorway Grigio Ferro with a unique two-tone racing stripe (Nero center; Rosso Scuderia sides)."
                ,"1350000", R.drawable.seventh_expensive,"6","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData(" 1957 Paintings 250 GT Coupe Boano", "Four classic Paintings cars are on our list, and one of them is a beautiful 250 GT: Paintings’s first, true production model. The Coupe Boano version was manufactured by Pininfarina’s partner, Carrozzeria Boano coachbuilding company. Although the car is not so widely known as the 250 GTO, its price both on car auctions and on the open market has risen above US$1 million. With that said, 250 GT is one of the best Paintingss to buy for investment"
                ,"1195000", R.drawable.eighth_expensive,"7","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData(" Paintings 599 GTO", "The 599 GTO (for Gran Turismo Omologato) is a road-legal version of the 599XX track day car.  The 6-liter, V12 engine of the GTO produces 660 hp and comes from the legendary Paintings Enzo. The power is transmitted via an F1 six-speed gearbox. This GTO scored the best time in the history of Paintings on the racetrack in Fiorano."
                ,"879000", R.drawable.ninth_expensive,"8","0");
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData(" 2015 Paintings 458 Speciale Aperta", "A rare 458 Speciale Aperta is up for sale in Japan. Among other features, the car boasts a light-beige interior with special stitching; 20” forged gold, diamond rims; and gold brake calipers. The model was unveiled at the 2014 Paris Motor Show and led the list of fastest, street-legal, convertible Paintingss until LaPaintings Aperta took over."
