...
public class RegistrationActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user != null) {
            ...
            boolean firstStart = prefs.getBoolean("isFirstRun", true);
            if (firstStart) {
                onFirst();
            }
    ...
    private void sendUserData() {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toasty.error(RegistrationActivity.this, "Image Upload failed!", Toast.LENGTH_LONG).show();

            }
        }).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                Toasty.success(RegistrationActivity.this, "Image Upload successful!", Toast.LENGTH_LONG).show();
