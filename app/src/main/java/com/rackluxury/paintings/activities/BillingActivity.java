...
public class BillingActivity extends AppCompatActivity implements PurchasesUpdatedListener,
                ...
                if (list != null && billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK) {
                    ...
                    if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.USER_CANCELED) {
                        ...
                        if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.ITEM_ALREADY_OWNED) {
                            Toasty.info(BillingActivity.this, "Already Purchased", Toast.LENGTH_LONG).show();
        ...
        billingClient.startConnection(new BillingClientStateListener() {
            ...
            public void onBillingSetupFinished(@NonNull BillingResult billingResult) {
                if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK) {
                    ...
                    Toasty.success(BillingActivity.this, "Successfully connected to Billing client", Toast.LENGTH_LONG).show();
    ...
    private void setPurchaseSuccessDialogue() {
        final PurchaseSuccessDialogue purchaseSuccessDialogue = new PurchaseSuccessDialogue(BillingActivity.this);
