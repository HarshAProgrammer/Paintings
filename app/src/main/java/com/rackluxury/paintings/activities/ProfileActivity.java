...
import com.rackluxury.paintings.adapters.UserProfile;
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                if (user.getPhotoUrl() != null) {
                    ...
                    changePassword.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Toasty.info(ProfileActivity.this, "Unable to Change Password, As You are Logged in through Facebook.", Toast.LENGTH_SHORT).show();
                        }
                    });
                    profileUpdate.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Toasty.info(ProfileActivity.this, "Unable to Update Profile, As You are Logged in through Facebook.", Toast.LENGTH_SHORT).show();
                        }
                    });
